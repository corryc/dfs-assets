...
- [ ] No banned phrases ("guaranteed", "certain", "avoid all LMI")
- [ ] No specific rates or borrowing ranges
- [ ] Phone: 0419 891 983 (if mentioned anywhere)
